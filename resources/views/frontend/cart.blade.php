                        ...
                        <tr>
                            <td>
                                <div class="cart_product">
                                    <img src="{{ asset('storage/products/' .$cart->inventory->product->image) }}" alt="image_not_found">
                                    <h3><a href="shop_details.html">{{ $cart->inventory->product->title }}</a></h3>
                                </div>
                            </td>
                            <td class="text-center">$<span class="price_text">{{ $cart->inventory->product->price }}</span></td>
