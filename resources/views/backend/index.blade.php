...
<div class="container-fluid page__container">
            ...
            <div class="card card-group-row__card">
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <small class="d-flex align-items-start font-weight-bold text-muted mb-2">
                        ...
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 4.0%</span>
                    </small>
                    <small class="d-flex align-items-start font-weight-bold text-muted mb-2">
                        <span class="flex d-flex flex-column">
                        ...
                        <span class="mx-3">7.04%</span>
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 2.0%</span>
                    </small>
                    <small class="d-flex align-items-start font-weight-bold text-muted">
                        ...
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 1.4%</span>
                    </small>
                </div>
            </div>
        </div>
            ...
            <div class="card card-group-row__card">
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                        ...
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 5.8%</span>
                    </small>
                    <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                        <span class="flex text-body">Canada</span>
                        <span class="mx-3">928</span>
                        <span class="d-flex align-items-center"><i class="material-icons text-danger icon-16pt mr-1">arrow_downward</i> 3.2%</span>
                    </small>
                    <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                        <span class="flex text-body">Germany</span>
                        <span class="mx-3">674</span>
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 2.1%</span>
                    </small>
                    <small class="d-flex align-items-center font-weight-bold text-muted mb-1">
                        <span class="flex text-body">Mexico</span>
                        <span class="mx-3">258</span>
                        <span class="d-flex align-items-center"><i class="material-icons text-danger icon-16pt mr-1">arrow_downward</i> 4.8%</span>
                    </small>
                    <small class="d-flex align-items-center font-weight-bold text-muted">
                        <span class="flex text-body">France</span>
                        <span class="mx-3">90</span>
                        <span class="d-flex align-items-center"><i class="material-icons text-success icon-16pt mr-1">arrow_upward</i> 9.8%</span>
                    </small>
                </div>
            </div>
        </div>
    ...
    <div class="card-deck card-margin">
        <div class="card">
            <img src="assets/images/posts/thought-catalog-214785.jpg"
                 class="card-img-top"
                 alt="">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="author-info">
                        <a href=""
                           class="text-body">Adrian Demian</a>
                        <p class="text-muted mb-0">Senior Front-End Developer</p>
                    </div>
                </div>
                <h5 class="card-title"><a href=""
                       class="headings-color">UI Design &amp; Code</a></h5>
            ...
            <div class="card-footer d-flex justify-content-between">
                <a href="#"
                   class="text-social text-facebook">
                    <svg viewBox="0 0 16 16"
                         width="20%"
                         xmlns="http://www.w3.org/2000/svg"
                         clip-rule="evenodd"
                ...
                <a href="#"
                   class="text-social text-twitter">
                    <svg viewBox="0 0 16 16"
                         width="20%"
                         xmlns="http://www.w3.org/2000/svg"
                         clip-rule="evenodd"
                ...
                <a href="#"
                   class="text-social text-instagram">
                    <svg viewBox="0 0 16 16"
                         width="20%"
                         xmlns="http://www.w3.org/2000/svg"
                         clip-rule="evenodd"
                ...
                <a href="#"
                   class="text-social text-dribbble">
                    <svg viewBox="0 0 16 16"
                         width="20%"
                         xmlns="http://www.w3.org/2000/svg"
                         clip-rule="evenodd"
        ...
        <div class="card dashboard-chat">
            ...
            <div class="d-flex dashboard-chat__head">
                ...
                <div class="flex">
                    <a href=""
                       class="text-body">Steven Short</a>
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle btn btn-white btn-sm text-muted"
                       href="#"
                       id="chatSettings"
                       data-toggle="dropdown"
                       aria-haspopup="true"
