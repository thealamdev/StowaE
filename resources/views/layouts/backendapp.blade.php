                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="sidebar-menu-item active">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="dashboards_menu">
                                        <li class="sidebar-menu-item active">
                                            <a class="sidebar-menu-button" href="{{ route('dashboard.dashboard') }}">
                                ...
                                <li class="sidebar-menu-item active {{ Route::is('dashboard.order.*') ? "open" : '' }}">
                                    <a class="sidebar-menu-button" data-toggle="collapse" href="#order_menu">
                                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i>
                                        <span class="sidebar-menu-text">Order Management</span>
                                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                    </a>
                                    <ul class="sidebar-submenu collapse" id="order_menu">
                                        <li class="sidebar-menu-item {{ Route::is('dashboard.order.*') ? "active" : '' }}">
                                        ...
                                        <li class="sidebar-menu-item {{ Route::is('dashboard.order.*') ? "active" : '' }}">
                                            <a class="sidebar-menu-button" href="{{ route('dashboard.order.create') }}">
                                                <span class="sidebar-menu-text">Show</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-menu-item active">
                                    ...
                                    @can('edit')
                                        <ul class="sidebar-submenu collapse" id="role_assign">
                                            <li class="sidebar-menu-item active">
                                ...
                                <li class="sidebar-menu-item active">
                                    ...
                                    @can('edit')
                                        <ul class="sidebar-submenu collapse" id="role_permission">
                                            <li class="sidebar-menu-item active">
                                                <a class="sidebar-menu-button"
                                ...
                                <li class="sidebar-menu-item active">
                                    <a class="sidebar-menu-button" data-toggle="collapse" href="#setting_menu">
                                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i>
                                        <span class="sidebar-menu-text">Settings</span>
                                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                    </a>
                                    <ul class="sidebar-submenu collapse" id="setting_menu">
                                        <li class="sidebar-menu-item active">
                                            <a class="sidebar-menu-button"
                                ...
                                <a href="profile.html"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        ...
                                        <small class="text-muted text-uppercase">
                                            {{ auth()->user()->roles->pluck('name') }}</small>
                                    </span>
                                </a>
