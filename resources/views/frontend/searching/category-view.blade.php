                            ...
                            <div class="row align-items-center">
                                <div class="col col-md-4">
                                    <ul class="layout_btns nav" role="tablist">
                                        ...
                                        <li>
                                            <button data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" class="">
                                                ...
                                                <span class="price">
                                                    <ins>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi> <span class="woocommerce-Price-currencySymbol">$</span>{{ $product->sale_price ?? $product->price }} </bdi>
                                                        </span>
                                                    </ins>
                                                </span>
                                                <div class="add-cart-area">
                                                    <a href="{{ route('frontend.shop.show',$product->product_slug) }}"> <button class="add-to-cart">Add to cart</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
