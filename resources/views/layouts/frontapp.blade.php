                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index-2.html">
                                    ...
                                    <img src="{{ asset('assets/frontend/images/logo/logo_1x.png') }}"
                                        srcset="{{ asset('assets/frontend/images/logo/logo_2x.png 2x') }}"
                                        alt="asset('assets/frontend/images/logo/logo_1x.png')">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="allcategories_collapse collapse {{ request()->routeIs('frontend.home') ? 'show' : '' }}"
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                <li>
                                    <a href="contact.html">
                                        <svg role="img" xmlns="http://www.w3.org/2000/svg" width="30px"
                                            height="30px" viewBox="0 0 24 24" aria-labelledby="locationIconTitle"
                                ...
                                <li>
                                    <a href="compare.html">
                                        <svg role="img" xmlns="http://www.w3.org/2000/svg" width="30px"
                                            height="30px" viewBox="0 0 24 24" aria-labelledby="rotateIconTitle"
                                            stroke="#051d43" stroke-width="1" stroke-linecap="square"
                                            stroke-linejoin="miter" fill="none" color="#2329D6">
                                ...
                                <li>
                                    <a href="wishlist.html">
                                        <svg role="img" xmlns="http://www.w3.org/2000/svg" width="30px"
                                            height="30px" viewBox="0 0 24 24" aria-labelledby="favouriteIconTitle"
                                            stroke="#051d43" stroke-width="1" stroke-linecap="square"
                                            stroke-linejoin="miter" fill="none" color="#2329D6">
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_1.jpg') }}"
                                    alt="asset('assets/frontend/images/cart/cart_img_1.jpg')">
                            </div>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_2.jpg') }}"
                                    alt="asset('assets/frontend/images/cart/cart_img_2.jpg')">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_3.jpg') }}"
                                    alt="asset('assets/frontend/images/cart/cart_img_3.jpg')">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                                                                    ...
                                                                    <div class="nice-select" tabindex="0"><span
                                                                        ...
                                                                        <ul class="list">
                                                                            <li data-value="Choose A Option"
                                                                                ...
                                                                                class="option selected">Choose A Option
                                                                            </li>
                                                                            <li data-value="1" class="option">Some
                                                                                option</li>
                                                                            <li data-value="2" class="option">Another
                                                                                option</li>
                                                                            <li data-value="3"
                                                                                class="option disabled">A disabled
                                                                                option</li>
                                                                            <li data-value="4" class="option">Potato
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img
                                                src="{{ asset('assets/frontend/images/app_store.png') }}"
                                                alt="asset('assets/frontend/images/app_store.png')"></a></li>

                                    <li><a href="#!"><img
                                                src="{{ asset('assets/frontend/images/play_store.png') }}"
                                                alt="asset('assets/frontend/images/play_store.png')"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('assets/frontend/images/payments_icon.png') }}"
                                    alt="image_not_found">
                            </div>
                        </div>
                    </div>
