                            ...
                            <div class="product-area shop-grid-product-area row">
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        ...
                                        <img src="{{ asset('storage/products/' .$product->image) }}" alt="{{ $product->image }}" width="250" height="100">
                                        <div class="actions">
                                            <ul>
                                                <li>
                                                    <a href="#">
                                    ...
                                    <div class="details">
                                        ...
                                        <div class="add-cart-area">
                                            <a href="{{ route('frontend.shop.show',$product->slug) }}"><button class="add-to-cart">Add to cart</button></a>
                                        </div>
                                    </div>
                                </div> 
